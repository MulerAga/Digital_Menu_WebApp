      ...
      <div className="flex flex-wrap gap-2 pb-2">
        <button
          ...
          className={`flex-shrink-0 px-4 py-2 rounded-full text-sm font-medium transition-all
            ${!selectedCat ? "bg-primary-500 text-white shadow-md" : "bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-gray-700 hover:border-primary-300"}`}
        >
          All
        </button>
        {categories.map((cat) => (
